...
class AfiliadoORM(Base):
    ...
    marca_temporal_creacion = Column(
        DateTime, server_default=func.now(), nullable=False
    )
    marca_temporal_actualizacion = Column(
    ...
    id_nivel_educativo = Column(
        Integer, ForeignKey("niveles_educativos.id"), nullable=True
    )
    id_relacion_dependencia = Column(
        Integer, ForeignKey("relaciones_dependencia.id"), nullable=True
    )
    id_estado_afiliado = Column(
        Integer, ForeignKey("estados_afiliado.id"), nullable=False
    )
