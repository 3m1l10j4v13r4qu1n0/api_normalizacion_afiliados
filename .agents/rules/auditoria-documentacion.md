...
la auditoría de infraestructura (09/09/2026) generó `docs/06_auditorias/auditoria-infraestructura.md`


## 2. Alcance

- Aplica a auditorías de cualquier documento de `docs/` (análisis funcional, backend).

## 3. Pasos obligatorios

1. **Identificar** el grupo/área del documento auditado (1=global, 2=tecnico, 3=procesos,
   4=historias_usuario, 5=metodologi_agil, 6=auditorias).
